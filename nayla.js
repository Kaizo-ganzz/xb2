...
{"urlButton": {"displayText": "SOURCE CODE","url": "https://www.youtube.com/channel/UC8v7LaOeOvtNECoXF5Q9cfg"}},
...
case 'scbot': 
if (!isRegistered) return reply("ANDA BELUM TERDAFTAR DI DATABASE BOT, SILAHKAN KETIK " + `${prefix}daftar ` + "UNTUK BERGABUNG")
reply("https://www.youtube.com/channel/UC8v7LaOeOvtNECoXF5Q9cfg")
break
case 's':
case 'sticker':
case 'stiker':
